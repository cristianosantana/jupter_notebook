...
def gerar_relatorio_pdf(
    ...
    elements.append(Paragraph("Agente: agente-analise-os | Orquestrador: Maestro", styles["corpo"]))
    ...
    notas = [
        ...
        f"<b>Geração:</b> Relatório gerado automaticamente em {data_geracao} pelo agente-analise-os, "
