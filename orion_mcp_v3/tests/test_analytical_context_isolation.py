...
def test_evidence_block_exports_answer_signature_metadata() -> None:
    ...
    evidence = EvidenceBlock(
        ...
        supporting_data={"direct_answer": {"plan": {"measure": "faturamento"}}},
    )
    ...
    assert signature.measure == "faturamento"
    assert evidence_block.metadata["answer_plan"] == evidence.metrics["answer_plan"]
    assert evidence_block.metadata["metrics_value_key"] == "faturamento"
    assert evidence_block.metadata["analytical_signature"]["measure"] == "faturamento"
