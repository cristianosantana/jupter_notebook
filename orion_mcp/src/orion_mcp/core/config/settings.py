...
class Settings(BaseSettings):
    ...
    tool_domain_include_raw_rows: bool = Field(
        default=False,
        description=(
            "Se true: com summarize=true, o MCP inclui também rows_sample (limitado) no envelope "
            "para depuração ou drill-down; o LLM continua a preferir drl_* no DataInterpreter. "
            "Env: ORION_TOOL_DOMAIN_INCLUDE_RAW_ROWS."
        ),
    )
