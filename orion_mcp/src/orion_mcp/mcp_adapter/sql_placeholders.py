"""Substituição segura de placeholders nos SQL whitelisted (project_mcp_v1 compat)."""
    ...
    *,
    ...
    if needs_from or needs_to:
        if not date_from or not date_to:
            raise ValueError("Esta consulta exige date_from e date_to (formato YYYY-MM-DD).")
