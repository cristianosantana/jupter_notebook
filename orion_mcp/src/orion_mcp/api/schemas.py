...
class ChatRequest(BaseModel):
    ...
    include_raw_rows: bool | None = Field(
        default=None,
        description=(
            "Se true e summarize compacto: o MCP pode incluir rows_sample limitado no envelope "
            "(ORION_TOOL_DOMAIN_INCLUDE_RAW_ROWS no servidor como defeito alternativo)."
        ),
    )
